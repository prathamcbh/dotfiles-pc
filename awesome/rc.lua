...
screen.connect_signal("property::geometry", function(s)
    ...
    theme.wallpaper = "/home/pratham/Downloads/wallpapers/spiderman.jpg"
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "r",
    function ()
        awful.spawn(string.format("dmenu_run -i -fn NotoMonoRegular:bold:pixelsize=14", -- -nb '#191919' -nf '#fea63c' -sb '#fea63c' -sf '#191919' -fn NotoMonoRegular:bold:pixelsize=14",
        beautiful.bg_normal, beautiful.fg_normal, beautiful.bg_focus, beautiful.fg_focus))
  	end,
    {description = "run dmenu terminal", group = "hotkeys"}),
...
--  awful.key({ modkey }, "F7", function () awful.util.spawn( "virtualbox" ) end,
 ...
 -- awful.key({ modkey }, "F8", function () awful.util.spawn( filemanager ) end,
  ...
  awful.key({ modkey }, "F10", function () awful.util.spawn( "pavucontrol" ) end,
      {description = "pulseaudio control" , group = "function keys" }),
...
--        {description = "rofi theme selector", group = "super"}),
    ...
    -- ctrl + shift + ...
    awful.key({ modkey1, "Shift"  }, "Escape", function() awful.util.spawn( terminal, "-e htop" ) end),
...
--        {description = "view next", group = "tag"}),
 ...
 -- Show/Hide Systray
    ...
    awful.key({ modkey,           }, "Return", function () awful.spawn(terminal) end,
              {description = terminal, group = "super"}),
    awful.key({ altkey,           }, "n", function () awful.spawn("notepadqq") end,
              {description = "notpadqq", group = "altkey"}),
    
    awful.key({ modkey, "Shift" }, "r", awesome.restart,
              {description = "reload awesome", group = "awesome"}),
	      
    awful.key({ altkey,           }, "Return", function () awful.spawn(browser1) end,
              {description = browser1, group = "altkey"}),
